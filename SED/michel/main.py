...
if __name__ == '__main__':
    ...
    store_dir = os.path.join("stored_data", "best_4layers_0688_opt_2" + add_dir_model_name)
    ...
    for epoch in range(cfg.n_epoch):
        ...
        loss_value, meters = train(training_loader, crnn, optim, epoch,
        ...
        if crnn.trainable_pcen is not None:
            pcen_parameters.append({key: torch.tensor(value)
        ...
        validation_file.append(valid_synth_f1)
        np.save('validation/best_4layers_0688_opt_2', validation_file)
        #-------------------------------
